...
export function LoginPage() {
  ...
  const [email, setEmail] = useState(
    "operator@safarijunctionsadventures.co.tz",
  );
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center px-4 bg-gradient-to-b from-brass-50 via-forest-50 to-moss-50">
      ...
      />
      <div
        className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-moss-900/10 to-transparent"
        aria-hidden
      />
      ...
      >
        ...
        <p className="text-sm text-earth-500 mb-7">
          Sales operating system — sign in
        </p>
        ...
        <input
          className="w-full border border-sand-300 rounded-lg px-3 py-2.5 mb-4 text-sm focus:outline-none focus:ring-2 focus:ring-forest-400 focus:border-transparent"
          value={email}
        ...
        <input
          className="w-full border border-sand-300 rounded-lg px-3 py-2.5 mb-5 text-sm focus:outline-none focus:ring-2 focus:ring-forest-400 focus:border-transparent"
          value={password}
        ...
        <p className="text-xs text-earth-400 mt-5 text-center">
          Demo accounts: operator@…, manager@…,
          admin@safarijunctionsadventures.co.tz — password{" "}
          <code className="bg-sand-100 px-1 py-0.5 rounded">
            safaribrain-demo
          </code>
        </p>
