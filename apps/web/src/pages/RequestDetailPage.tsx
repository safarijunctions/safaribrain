  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-2 space-y-6">
        <section className="bg-white border border-stone-200 rounded-xl p-5 shadow-sm shadow-forest-900/5">
          <h1 className="font-display text-lg font-semibold text-forest-800">{request.contact.fullName}</h1>
        ...
        <section className="bg-white border border-stone-200 rounded-xl p-5 shadow-sm shadow-forest-900/5">
          <h2 className="font-display font-semibold text-forest-800 mb-3">Quotes</h2>
        ...
        {booking && (
          <section className="bg-white border border-stone-200 rounded-xl p-5 shadow-sm shadow-forest-900/5">
            <h2 className="font-display font-semibold text-forest-800 mb-3">Booking</h2>
      ...
      <div className="space-y-6">
        <section className="bg-white border border-stone-200 rounded-xl p-5 shadow-sm shadow-forest-900/5">
          <h2 className="font-display font-semibold text-forest-800 mb-3">AI reply assistant</h2>
          <ReplyDraftPanel requestId={request.id} />
        </section>

        <section className="bg-white border border-stone-200 rounded-xl p-5 shadow-sm shadow-forest-900/5">
          <h2 className="font-display font-semibold text-forest-800 mb-3">Tasks</h2>
        ...
        <section className="bg-white border border-stone-200 rounded-xl p-5 shadow-sm shadow-forest-900/5">
          <h2 className="font-display font-semibold text-forest-800 mb-3">Activity</h2>
          <ul className="space-y-3 text-sm">
            {request.pipelineLog.map((p) => (
              <li key={p.id}>
                <p className="font-medium text-xs uppercase tracking-wide text-forest-700">{p.stage}</p>
