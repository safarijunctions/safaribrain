    ...
    <div className="min-h-screen relative overflow-hidden py-10 px-4 bg-gradient-to-b from-brass-50 via-forest-50 to-moss-50">
      ...
      <div className="relative max-w-2xl mx-auto bg-white rounded-2xl shadow-xl shadow-forest-900/10 border border-white overflow-hidden">
        ...
        <div className="p-7 space-y-7">
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-forest-800 mb-3">Price</h2>
            <table className="w-full text-sm">
              <tbody>
                ...
                {breakdown.discountAmount > 0 && (
                  <tr className="border-t border-stone-100 text-moss-700">
            ...
            <section className="border-t border-stone-200 pt-6 space-y-3">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 border border-stone-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-forest-400 focus:border-transparent"
                  value={note}
          ...
          {(data.status === "ACCEPTED" || actionDone === "accepted") && (
            <p className="text-center text-moss-700 font-medium">🎉 Accepted — your safari expert will be in touch to confirm next steps.</p>
          )}
          {(data.status === "CHANGES_REQUESTED" || actionDone === "changes-requested") && (
            <p className="text-center text-brass-700 font-medium">Thanks — we've flagged your changes to your safari expert.</p>
          )}
        </div>
      </div>
    </div>
