...
function StatTile({ label, value, sub }: { label: string; value: string | number; sub?: string }) {
  return (
    <div className="bg-white border border-stone-200 rounded-xl p-4 shadow-sm shadow-forest-900/5">
      <p className="text-xs text-stone-500">{label}</p>
      <p className="font-display text-2xl font-semibold text-forest-800 mt-1">{value}</p>
